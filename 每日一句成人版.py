...
IMAGE_APIS = [
    ...
    # 随机获取一张 R18 图片
    "https://api.lolicon.app/setu/v2?r18=1&num=1",
    "https://api.pixivweb.com/anime18r.php?return=img",
    # 1. Pixiv 国内镜像源
...
# ===== 每日一句/诗词API列表 =====
QUOTE_APIS = [
    "https://api.vvhan.com/api/text/love",                 # 情话
    "https://v1.hitokoto.cn/?c=d&c=h&c=k",                 # 一言
    "https://v1.hitokoto.cn/?c=a&c=b&c=c&c=d&c=e&c=f&c=g&c=h&c=k&c=l", # 一言排除古诗词版
    "https://api.uomg.com/api/rand.qinghua?format=json",   # uomg随机情话
    "https://uapis.cn/api/v1/saying",                       # 随机土味情话
    ...
    "https://zenquotes.io/api/random",                      # ZenQuotes英文文学名言
    "https://v1.hitokoto.cn/?c=i",                          # 一言只选古诗词版
]
